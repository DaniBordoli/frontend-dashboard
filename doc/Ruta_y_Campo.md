...
### Dashboard operativo
Vista rápida de:
- ⚠️ Pedidos sin cotizar (básico implementado, falta detalle)
- ⚠️ Pedidos confirmados sin camión (básico implementado, falta detalle)
...
## COULD (opcionales)
### Métricas simples
- ⚠️ Cantidad de viajes (básico implementado)
- ❌ Volumen
